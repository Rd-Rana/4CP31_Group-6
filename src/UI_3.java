...
if (cr instanceof DefaultTreeCellRenderer) {
  ...
  dtcr.setOpenIcon(tnode3on);
      ...
      public JButton createZeroButton() {
        ...
        JLabel file1butt=new JLabel(closeteron);
        JLabel file2butt=new JLabel(closeteron);
        JLabel file3butt=new JLabel(closeteron);
        JLabel file4butt=new JLabel(closeteron);
        JLabel file5butt=new JLabel(closeteron);
         ...
         rename.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                try{
                    ...
                    String filecurrpath=filepathrmeta.readLine();
                    for(int iorb=1;iorb<fileselect;iorb++){
                        filecurrpath=filepathrmeta.readLine();
                    }
                    // System.out.println(filecurrpath);
                    File tempfile_1=new File(filecurrpath);
                    // System.out.println(tempfile_1.exists());
                    // System.out.println(tempfile_1.canRead());
                    // System.out.println(tempfile_1.canWrite());
                    String filerenamepath="C:\\Users\\Vishal\\Documents\\Dev_1.java";
                    File tempfile_2=new File(filerenamepath);
                    Boolean x=tempfile_1.renameTo(tempfile_2);
